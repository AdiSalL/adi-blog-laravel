...
<form action="{{route('register-user')}}" method="POST" enctype="multipart/form-data">
    ...
    <label class="input input-bordered flex items-center gap-2"  for="name">
        Name
        <input type="text"  name="name" class="grow" placeholder="John Doe" />
        @error('name')
        <div role="alert" class="alert alert-error">
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    <label class="input input-bordered flex items-center gap-2"  for="email">
        Email
        <input type="text"  name="email" class="grow" placeholder="email@yourmail.com" />
        @error('email')
        <div role="alert" class="alert alert-error">
            <svg
              xmlns="http://www.w3.org/2000/svg"
    ...
    <br>
    <div>
        <button type="submit" class="btn btn-wide">Register Your Account</button>
    </div>
    <br>
